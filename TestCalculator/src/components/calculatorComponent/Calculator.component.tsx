    ...
    return (
        <View style={CalculatorScreenStyled.calculatorContainer}>
            ...
            <View style={CalculatorScreenStyled.topContainer}>
                ...
                <ButtonComponent buttonText={DIVIDE} isOrange onPress={() => handleOperationPress(DIVIDED)} />
            </View>
            <View style={CalculatorScreenStyled.topContainer}>
                ...
                <ButtonComponent buttonText={MULTIPLY} isOrange onPress={() => handleOperationPress(MULTIPLIES)} />
            </View>
            <View style={CalculatorScreenStyled.topContainer}>
                ...
                <ButtonComponent buttonText={MINUS} isOrange onPress={() => handleOperationPress(MINUS)} />
            </View>
            <View style={CalculatorScreenStyled.topContainer}>
                ...
                <ButtonComponent buttonText={PLUS} isOrange onPress={() => handleOperationPress(PLUS)} />
            </View>
            <View style={CalculatorScreenStyled.topContainer}>
